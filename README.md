...
### C言語
epoll_waitを含むイベントループを自分で管理し、発生したイベントを条件分岐で処理できる。構造体の初期化やバイトオーダーの変換処理が必要である。
### Go言語
受信処理をGoroutineとして切り出し、Goのランタイムが内部的にepoll等を管理するため、コード上では「入力待ち」と「受信待ち」を独立した直列処理として扱える。
...
<p align="center">
  <img src="images/10.100.0.10.png" width="300">
  <img src="images/10.100.0.20.png" width="300">
</p>
